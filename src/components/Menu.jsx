        ...
        <div className="flex md:order-2">
          {
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button onClick={handleSetTheme} className="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-200 rounded-lg text-sm p-2 inline-flex items-center dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                {
                  currentTheme === 'dark' ?
                    <svg
